...
from scrape_lego_direct import fetch_lego_product, load_price_history, update_price_history, ProxyManager
from lego_scraper_workflow import setup_directories
